...
public class AddVendorHandler implements ActionHandler {

    private final TicketingService ticketingService;
    private final IEventLogger logger;

    public AddVendorHandler(TicketingService ticketingService, IEventLogger logger) {
    ...
    public void handle(String[] params) {
        if (params.length == 2) {
            ...
            logger.error("Invalid parameters for addVendor");
        }
    }
}
